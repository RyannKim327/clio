  ...
  return (
    <div className="flex flex-col items-center">
      ...
      <p className="border-l-2 border-l-solid border-l-border pl-2">
        ...
        giving each moment its own emotional depth.
        It is a space where writers can share their work and readers can lose themselves in stories that are not just read, but felt.
        From serialized fiction to intimate poetry, Clio is designed for anyone who believes that great stories deserve a great atmosphere.
      </p>
    </div>
  )
}
