...
export default function Book({
  ...
  return (
    <div className="relative aspect-9/16 border border-solid border-fg rounded group">
      {cover ?
      ...
      <div className="flex flex-col p-2 max-h-1/3 absolute bottom-0 z-10 bg-bg/50 w-full opacity-0 transition-all delay-75 group-hover:opacity-100">
        <span>{title}</span>
